      ...
      <header className="sticky top-0 z-50 border-b border-white/5 bg-[#050816]/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3 lg:px-8">
          ...
          <nav className="hidden items-center gap-5 lg:flex">
            <a href="#product" className="text-xs text-slate-300 transition hover:text-white">Product</a>
            <a href="#solutions" className="text-xs text-slate-300 transition hover:text-white">Solutions</a>
            <a href="#developers" className="text-xs text-slate-300 transition hover:text-white">Developers</a>
            <a href="#resources" className="text-xs text-slate-300 transition hover:text-white">Resources</a>
            <a href="#company" className="text-xs text-slate-300 transition hover:text-white">Company</a>
          </nav>
      ...
      <section className="relative overflow-hidden">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 lg:grid-cols-[1fr_1.1fr] lg:px-8 lg:py-16">
          ...
          <div className="flex items-center justify-center lg:pl-4">
            <div className="relative w-full max-w-4xl overflow-hidden rounded-xl border border-slate-800 bg-[#0A1222] shadow-2xl shadow-blue-900/30">
              ...
              <div className="relative h-[280px] w-full overflow-hidden sm:h-[340px] lg:h-[380px]">
                <img
                  ...
                  className="absolute left-0 top-0 w-[180%] max-w-none origin-top-left"
                />
              </div>
            </div>
          </div>
        ...
        <div className="overflow-hidden rounded-lg border border-blue-500/20 bg-[linear-gradient(135deg,rgba(37,99,235,0.16),rgba(10,18,34,0.98)_42%,rgba(34,211,238,0.08))] px-5 py-6 shadow-[0_12px_30px_rgba(37,99,235,0.1)] sm:px-6 sm:py-7">
          <div className="grid gap-5 lg:grid-cols-[1.15fr_auto] lg:items-center">
            <div>
              ...
              <p className="mt-2 max-w-lg text-[11px] leading-5 text-slate-300">
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_2.5fr]">
            <div>
              ...
              <div className="mt-3 flex gap-1.5">
                <a href="#" className="flex h-5 w-5 items-center justify-center rounded border border-slate-800 text-slate-400 transition hover:border-slate-700 hover:text-slate-300">
